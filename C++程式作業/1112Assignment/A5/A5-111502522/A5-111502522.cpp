...
bool cmp(University obj1, University obj2)
{
    if (obj1.graduates_last_year >= obj2.graduates_last_year)
    {
        return true;
    }
    else if (obj1.graduates_last_year < obj2.graduates_last_year)
    {
        return false;
    }
    return true;
...
int main()
{
    ...
    sort(universities.begin(), universities.end(), cmp);
